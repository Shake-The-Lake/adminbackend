...
public class BookingMapperTest {
    ...
    void toDtoExtendedMapsCorrectly() {
        ...
        when(timeSlotMapper.toDto(timeSlot)).thenReturn(new TimeSlotDto(2L, null, null, 1L, new HashSet<>(), ""));
        when(personMapper.toDto(person)).thenReturn(
                new PersonDto(3L, null, List.of(), "", "", "", "", new HashSet<>()));
